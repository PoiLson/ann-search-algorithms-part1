...
//computes the dot product of a float vector and an int vector (converts int to float)
...
//computes the Euclidean distance between two int vectors (converts to float)
